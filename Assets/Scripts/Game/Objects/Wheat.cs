...
namespace Game
{
    public class Wheat : MonoBehaviour
    {
        ...
        void Start()
        {
            transform.Rotate(new Vector3(Random.Range(_randomRotX.x, _randomRotX.y), 0, Random.Range(_randomRotZ.x, _randomRotZ.y)));
            transform.localScale = new Vector3(transform.localScale.x, Random.Range(_randomScaleY.x, _randomScaleY.y), this.transform.localScale.z);
